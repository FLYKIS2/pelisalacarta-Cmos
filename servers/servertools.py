...
FREE_SERVERS.extend(['uptobox','videozed','documentary','hugefiles', 'firedrive','videott','tumitv','gamovideo'])
...
FREE_SERVERS.extend(['meuvideos','openload','cumlouder','v4y','streamable','videostoring','youwatch'])
FREE_SERVERS.extend(['vodlocker','thevideome','rocvideo','vidxtreme','vidtome','vidzi','letwatch','sendvid','cnubis']) #,'vimpleru'])
