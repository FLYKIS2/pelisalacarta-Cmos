...
def mainlist(item):
    ...
    itemlist.append( Item(channel=__channel__, action="search", title="Archivos Torrent", extra="torrent"))
...
def search(item,texto):
    ...
    if item.extra == "torrent":
        itemlist.append( Item(channel=__channel__, title = "Torrent", action="play", url=texto, server="torrent", folder=False) )
    else:
