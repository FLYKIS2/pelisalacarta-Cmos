...
def channels_list():
    ...
    itemlist.append( Item( title="Animeflv"                , channel="animeflv"           , language="ES" , category="A,VOS"       , type="generic"  ))
    itemlist.append( Item( title="Animeid"                 , channel="animeid"            , language="ES" , category="A,VOS"       , type="generic"  ))
    ...
    if config.get_setting("enableadultmode") == "true": itemlist.append( Item( title="Canal Porno"           , channel="canalporno"             , language="ES" , category="X,F" , type="generic"  ))
    ...
    itemlist.append( Item( title="Inkapelis"     , channel="inkapelis"         , language="ES" , category="F"   , type="generic"     ))
    itemlist.append( Item( title="ItaliaFilms.tv (IT)"     , channel="italiafilm"         , language="IT" , category="F,S,A"   , type="generic"     ))
    if config.get_setting("enableadultmode") == "true": itemlist.append( Item( title="Freejav"             , channel="freejav"            , language="JP" , category="X,F" , type="generic"  ))
    ...
    if config.get_setting("enableadultmode") == "true": itemlist.append( Item( title="Myhdlibrary"             , channel="myhdlibrary"            , language="JP" , category="X,F" , type="generic"  ))
    if config.get_setting("enableadultmode") == "true": itemlist.append( Item( title="Pelisxporno"             , channel="pelisxporno"            , language="ES" , category="X,F" , type="generic"  ))	
    ...
    itemlist.append( Item( title="Seriecanal"              , channel="seriecanal"         , language="ES" , category="S"          , type="generic" ))
